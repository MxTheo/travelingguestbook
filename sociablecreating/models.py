...
class LogMessage(models.Model):
    ...
    body          = models.TextField(max_length=30000, verbose_name='Bericht', help_text='Vertel iets over je ervaringen van het contact. Voel je vrij te delen wat je wilt delen en niet te delen wat je niet wilt delen.')
    date_created  = models.DateTimeField(auto_now_add=True, verbose_name='Datum aangemaakt')
